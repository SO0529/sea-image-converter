...
class ResidualDenseBlock_3C(nn.Module):
    def __init__(self, nf=64, gc=32, bias=True):
        ...
        # initialization
        module_utils.initialize_weights([self.conv1, self.conv2, self.conv3], 0.1)
...
class ResidualDenseBlock_5C(nn.Module):
    def __init__(self, nf=64, gc=32, bias=True):
        ...
        # initialization
        module_utils.initialize_weights([self.conv1, self.conv2, self.conv3, self.conv4, self.conv5], 0.1)
...
class RRDBModel(nn.Module):
    def __init__(self, in_nc, out_nc, nf, nb, gc):
        ...
        self.RRDB_trunk = module_utils.make_layer(RRDB_block_f, nb)
